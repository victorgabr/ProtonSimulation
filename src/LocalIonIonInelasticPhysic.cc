...
//
//
// In this class the models for ion-ion interactions at intermediate energies (0
// - 1 GeV per nucleon)
// can be activate. This class can be used alternatively to the "binary_ion"
// physics list
//
// The usefullness of this class is that you can explicitally see the total
// inelastic sections
// activated and the models called. Moreover you can choose to activate for ions
// (from deuteron
// to heavier nucleus) three different and exclusive models: the Binary Light
// Ion cascade, the QMD
// and The Wilson.

// For hadrotherapy pouposes, where distributions of produced fragments is
// importante we strongly
// suggest to use Binary or QMD. The Binary model is the default and at moment,
// you can swith beetween models decommenting
...
LocalIonIonInelasticPhysic::LocalIonIonInelasticPhysic(const G4String &name)
    ...
    G4cout << G4endl << "A local inelastic model is activated for all ions"
           << G4endl;
}
...
void LocalIonIonInelasticPhysic::ConstructProcess() {
    ...
    G4TripathiLightCrossSection *TripatiLightCrossSections =
    ...
    // *** Generic Ion ***
    // *******************
    G4IonInelasticProcess *genericIonInelasticProcess =
